    ...
    <div className="flex flex-col gap-3 group">
      {primeiraSessao && (
        <div className="flex flex-col items-center">
          <span className="text-[20px] text-zinc-500 uppercase tracking-widest font-bold">Estreia</span>
      ...
      >
        ...
        <div className="p-4 text-center bg-zinc-900">
          <p className="text-red-500 text-[13px] font-bold uppercase mb-1">{movie.categoria}</p>
